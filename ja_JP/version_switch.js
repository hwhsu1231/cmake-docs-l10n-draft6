(function() {
  ...
  const url_re = /hwhsu1231\.github\.io\/cmake-docs-l10n-draft6\/ja_JP\/(git-master|latest|(v\d\.\d+))\/(.*)/;
  const all_versions = {
  ...
  function patch_url(url, new_version) {
    ...
    if (match) {
      ...
      return url.replace(url_re, 'hwhsu1231.github.io/cmake-docs-l10n-draft6/ja_JP/' + new_version + '/' + filename);
    }
  }
      ...
      fetch(new_url)
        ...
        .catch((error) => {
          ...
          if (match) {
            ...
            window.location.href = 'https://hwhsu1231.github.io/cmake-docs-l10n-draft6/ja_JP/' + selected + '/index.html';
          }
        });
    }
  }
